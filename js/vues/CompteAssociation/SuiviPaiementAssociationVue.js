;function SuiviPaiementAssociationVue(pParam) {
	...
	this.construct = function(pParam) {
		...
		$.post(	"./index.php?m=CompteAssociation&v=SuiviPaiement", "pParam=" + toJsonURIEncode(lParam),
			function(lResponse) {
	...
	this.dialogAjoutOperation = function() {
		...
		$.post(	"./index.php?m=CompteAssociation&v=RemiseCheque", "pParam=" + toJsonURIEncode({fonction:"listeActive"}),
			function(lResponse) {
				Infobulle.init(); // Supprime les erreurs
				if(lResponse) {
					if(lResponse.valid) {
	...
	this.ajoutOperation = function(pIdRemiseCheque) {
		...
		if(lVr.valid) {
			...
			$.post(	"./index.php?m=CompteAssociation&v=RemiseCheque", "pParam=" + toJsonURIEncode(lVo),
				function(lResponse) {
					Infobulle.init(); // Supprime les erreurs
					if(lResponse) {
						if(lResponse.valid) {
	...
	this.validerPaiement = function(pIdOperation,pDialog) {
		...
		var lVo = { id:pIdOperation,
					fonction:"valider"};
		$.post(	"./index.php?m=CompteAssociation&v=SuiviPaiement", "pParam=" + toJsonURIEncode(lVo),
			function(lResponse) {
				Infobulle.init(); // Supprime les erreurs
				if(lResponse) {
					if(lResponse.valid) {
